...
Parallel Delphi multi-agent simulation with diverse perspectives.
"""
import asyncio
import os
import re
...
async def run_simulation(
    ...
    """
    Run a Delphi multi-agent simulation on a Polymarket question.
    Uses parallel LLM calls with diverse agent perspectives.
    """
